...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.ComboBoxSignal.setItemText(0, _translate("Form", "Seno"))
        self.ComboBoxSignal.setItemText(1, _translate("Form", "Coseno"))
        self.ComboBoxSignal.setItemText(2, _translate("Form", "3/2 Seno"))
        self.ComboBoxSignal.setItemText(3, _translate("Form", "Cuadrada"))
